        ...
        for (colliery_name, colliery_id) in collieries:
            ...
            while success:
                ...
                if end_time - start_time > 60: 
                    print("Timeout for next button")
                    success = 0
                    # break
                try:
                    print("getting the next button 113")
...
def scrape_past_dates(start_date="2017-01-01", end_date="2019-01-02"):
...
def scrape_entry_pages():
    ...
    driver.execute_script(
        "document.getElementsByClassName('form-control input-sm').example_length['3'].setAttribute('value', 1000)")
    select_1001 = driver.find_element_by_xpath("//*[@class = 'form-control input-sm']//*[@value = '1000']")
    select_1001.click()
    time.sleep(5)
    ...
    try:
        ...
        print("\n\n\n\n\n\n\n\n\n\npehla page ka data", len(colliery_data))
    except :
        print("\n\n\n\n\n\n\n\n\n\nerror at 282")
