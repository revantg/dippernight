    ...
    for area in area_info.keys():
        ...
        for (colliery_name, colliery_id) in collieries:
            ...
            temp_dict = {
                    ...
                    'colliery_area' : area_name,
                    'colliery_area_id': area_id,
...
def submit_values(area_id, area_name, colliery_id, colliery_name, start_date, end_date):
    ...
    while(True):
        ...
        end_time = time.time()
        if end_time - start_time > 20: return 0
    ...
    while True:
        try:
            # print("inside submit_values")
            end_time = time.time()
            if end_time - start_time > 15: return 0
...
def scrape_past_dates(start_date="2018-08-15", end_date="2018-08-17"):
